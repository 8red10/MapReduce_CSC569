...
client1: build_client
	$(CLIENT_DIR)/client -id=1 -server=$(SERVER)
client2: build_client
	$(CLIENT_DIR)/client -id=2 -server=$(SERVER)
client3: build_client
	$(CLIENT_DIR)/client -id=3 -server=$(SERVER)
client4: build_client
	$(CLIENT_DIR)/client -id=4 -server=$(SERVER)
client5: build_client
	$(CLIENT_DIR)/client -id=5 -server=$(SERVER)
client6: build_client
	$(CLIENT_DIR)/client -id=6 -server=$(SERVER)
client7: build_client
	$(CLIENT_DIR)/client -id=7 -server=$(SERVER)
client8: build_client
	$(CLIENT_DIR)/client -id=8 -server=$(SERVER)
